...
class RvvCoreWrapper(p: Parameters) extends BlackBox with HasBlackBoxInline
  ...
  addResource("hdl/verilog/rvv/design/Sram_256x128.v")
  ...
  addResource("hdl/verilog/rvv/design/rvv_backend_mxu_pe.sv")
  addResource("hdl/verilog/rvv/design/rvv_backend_mxu_unit.sv")
  addResource("hdl/verilog/rvv/design/rvv_backend_mxu_wrapper.sv")
